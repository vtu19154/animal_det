...
MODEL_DIR = 'F:/Vignesh/Image processing/wild animal detection/Real-Time-Animal-Species-Detection-main/runs/detect/train/weights/best.pt'
...
def main():
    # Load the YOLO model
    global model
    model = YOLO('F:/Vignesh/Image processing/wild animal detection/Real-Time-Animal-Species-Detection-main/runs/detect/train/weights/best.pt')
